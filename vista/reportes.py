...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../Escritorio/6to ciclo/Proyecto-Verificacion-Validacion-Datos/Recurso 6-100.jpg"))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.fondoErrores)
        self.label_2.setGeometry(QtCore.QRect(50, 30, 631, 291))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../Escritorio/6to ciclo/Proyecto-Verificacion-Validacion-Datos/carro.png"))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.fondoErrores)
        self.label_3.setGeometry(QtCore.QRect(1040, 450, 451, 311))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("../Escritorio/6to ciclo/Proyecto-Verificacion-Validacion-Datos/moto.png"))
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Escritorio/6to ciclo/Proyecto-Verificacion-Validacion-Datos/ver-observaciones.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../Escritorio/6to ciclo/Proyecto-Verificacion-Validacion-Datos/archivos.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
